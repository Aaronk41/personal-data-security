...
encrypt_label.place(x=210, y=220)

encrypt_instr = tk.Label(
    window,
   text="Click the encryption button to select a .txt or .csv\n Click the decryption button to select a .txt or .csv \n files will be saved as original name with [encrypted] and [decrypted]",
    bg=current_theme["bg"],
    fg=current_theme["fg"]
)
encrypt_instr.place(x=145, y=250)
...
ttk.Button(window, text="Encrypt", command=encrypt_file, style="Accent.TButton").place(x=200, y=330)

ttk.Button(window, text="Decrypt", command=decrypt_file, style="Accent.TButton").place(x=200, y=400)
...
stego_label.place(x=590, y=220)

stego_instr = tk.Label(
    window,
   text="To hide a file, click the hide button and select a .txt or .csv file that you wish to hide\nThen select the .png file you wish to carry the hidden material\nFinally select choose the file name of the hidden .png file\n\n To reveal a file, click the reveal button and select your hidden material .png\nName the revealed file and save",
    bg=current_theme["bg"],
    fg=current_theme["fg"]
)
stego_instr.place(x=500, y=250)
...
ttk.Button(window, text="Hide", command=hide_file, style="Accent.TButton").place(x=600, y=330)
ttk.Button(window, text="Reveal", command=reveal_file, style="Accent.TButton").place(x=600, y=400)
